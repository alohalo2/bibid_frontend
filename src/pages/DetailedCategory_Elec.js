...
const DetailedCategory_Elec = () => {
  ...
  const fetchBestProducts = useCallback(async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BACK_SERVER}:8080/auction/category/전자제품`, {
        params: { page: page }
      });
...
export default DetailedCategory_Elec;