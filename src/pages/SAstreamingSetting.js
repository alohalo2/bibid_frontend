...
const SAstreamingSetting = () => {
  ...
  useEffect(() => {
    const fetchAuctionAndChannelInfo = async () => {
      try {
        ...
        const channelResponse = await axios.get(`http://localhost:8080/live/info/${id}`, {
          headers: {
  ...
  return (
    <Container>
      ...
      <SAstreamingSettingContent publishUrl={channelInfo.publishUrl} streamKey={channelInfo.streamKey} />
...
export default SAstreamingSetting;