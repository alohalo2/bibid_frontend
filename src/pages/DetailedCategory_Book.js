...
const DetailedCategory_Book = () => {
  ...
  const fetchBestProducts = useCallback(async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BACK_SERVER}:8080/auction/category/도서`, {
        params: { page: page }
      });
...
export default DetailedCategory_Book;