...
function SAitem({ imageSrc, productName, auctionDate, auctionTime, linkText, alertText, handleGoButtonClick, handleAlertButtonClick}) {

  return (
    <div className="SAauctionItem">
      <img src={imageSrc} alt={productName} className="SAauctionImage" />
