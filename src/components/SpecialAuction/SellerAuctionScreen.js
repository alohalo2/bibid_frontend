...
//         const response = await axios.get(`${process.env.REACT_APP_BACK_SERVER}:8080/specialAuction/channelInfo/${auction.auctionIndex}`, { withCredentials: true });
...
//     axios.post(`${process.env.REACT_APP_BACK_SERVER}:8080/specialAuction/startLive/${auction.auctionIndex}`, {}, { withCredentials: true })
//       .then(response => {
...
//     axios.post(process.env.REACT_APP_BACK_SERVER + `:8080/specialAuction/endLive/${auction.auctionIndex}`, {}, { withCredentials: true })
//       .then(response => {
